...
CREATE TABLE IF NOT EXISTS `detail_kegiatan` (
  ...
  `detail_kegiatan` int(11) NOT NULL,
...
-- Dumping data for table monitoring_db.detail_kegiatan: ~0 rows (approximately)
...
INSERT INTO `kegiatan` (`id_kegiatan`, `id_tim`, `nama_kegiatan`, `tgl_mulai`, `tgl_selesai`, `id_periode`, `id_jenis_kegiatan`, `id_satuan`, `created_at`, `modified_at`) VALUES
	(1, 1, 'Kegiatan A', '2022-08-25', '2022-08-26', 2, 1, 1, '2022-08-25 21:01:30', '2022-08-26 14:16:32'),
	(43, 1, 'Kegiatan B', '2022-08-27', '2022-09-22', 1, 3, 1, '2022-08-26 14:18:04', '2022-08-26 14:18:04');
...
INSERT INTO `pegawai` (`id_pegawai`, `nama_pegawai`, `username`, `password`, `email`, `terakhir_login`) VALUES
	...
	(61, 'Bisma Ariasena Slamet SE., MAP', 'bisma.as', 'e10adc3949ba59abbe56e057f20f883e', 'bisma.as@bps.go.id', '2022-08-26 14:13:50'),
