...
-- Dumping structure for table monitoring_db.detail_kegiatan
CREATE TABLE IF NOT EXISTS `detail_kegiatan` (
  ...
  KEY `FK_detail_kegiatan_kegiatan` (`id_kegiatan`),
  CONSTRAINT `FK_detail_kegiatan_kegiatan` FOREIGN KEY (`id_kegiatan`) REFERENCES `kegiatan` (`id_kegiatan`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table monitoring_db.detail_kegiatan: ~4 rows (approximately)
/*!40000 ALTER TABLE `detail_kegiatan` DISABLE KEYS */;
INSERT INTO `detail_kegiatan` (`id_detail_kegiatan`, `detail_kegiatan`, `id_kegiatan`, `tgl_mulai`, `tgl_selesai`, `created_at`, `modified_at`) VALUES
	(51, 'test', 44, '2022-08-29', '2022-08-29', '2022-08-28', '2022-08-29 16:49:00'),
	(78, 'test4', 44, '2022-08-29', '2022-08-29', '2022-08-29', '2022-08-29 16:49:01'),
	(79, 'test3', 44, '2022-08-29', '2022-08-29', '2022-08-29', '2022-08-29 16:49:02'),
	(80, 'Percepatan', 44, '2022-08-29', '2022-08-29', '2022-08-29', '2022-08-29 16:49:04');
...
-- Dumping data for table monitoring_db.kegiatan: ~2 rows (approximately)
...
INSERT INTO `kegiatan` (`id_kegiatan`, `id_tim`, `nama_kegiatan`, `tgl_mulai`, `tgl_selesai`, `id_periode`, `id_jenis_kegiatan`, `id_satuan`, `created_at`, `modified_at`) VALUES
	(44, 2, 'Kegiatan B', '2022-08-11', '2022-08-27', 1, 3, 1, '2022-08-26 19:07:04', '2022-08-26 19:07:04'),
	(45, 1, 'Kegiatan C', '2022-08-16', '2022-08-24', 1, 1, 1, '2022-08-28 19:39:07', '2022-08-28 19:39:07'),
	(46, 7, 'Sakernas', '2022-08-29', '2022-09-30', 1, 1, 1, '2022-08-29 16:41:29', '2022-08-29 16:41:29');
/*!40000 ALTER TABLE `kegiatan` ENABLE KEYS */;

-- Dumping structure for table monitoring_db.laporan_alokasi_satker
CREATE TABLE IF NOT EXISTS `laporan_alokasi_satker` (
  `id_alokasi_satker` int(11) NOT NULL AUTO_INCREMENT,
  `id_detail_kegiatan` int(11) NOT NULL,
  `id_satker` int(11) NOT NULL,
  `target` varchar(100) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `modified_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id_alokasi_satker`) USING BTREE,
  KEY `kegitan_satker_fk_2` (`id_satker`),
  KEY `id_tim` (`id_detail_kegiatan`) USING BTREE,
  CONSTRAINT `FK_kegiatan_satker_detail_kegiatan` FOREIGN KEY (`id_detail_kegiatan`) REFERENCES `detail_kegiatan` (`id_detail_kegiatan`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dumping data for table monitoring_db.laporan_alokasi_satker: ~0 rows (approximately)
/*!40000 ALTER TABLE `laporan_alokasi_satker` DISABLE KEYS */;
/*!40000 ALTER TABLE `laporan_alokasi_satker` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `laporan_kegiatan` (
  ...
  KEY `FK_lkdk` (`id_detail_kegiatan`),
  CONSTRAINT `FK_lkdk` FOREIGN KEY (`id_detail_kegiatan`) REFERENCES `detail_kegiatan` (`id_detail_kegiatan`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pegawai` (`id_pegawai`, `nama_pegawai`, `username`, `password`, `email`, `terakhir_login`) VALUES
	...
	(61, 'Bisma Ariasena Slamet SE., MAP', 'bisma.as', 'e10adc3949ba59abbe56e057f20f883e', 'bisma.as@bps.go.id', '2022-08-29 09:24:03'),
...
CREATE TABLE IF NOT EXISTS `tim` (
  ...
  PRIMARY KEY (`id_tim`),
  KEY `ketua_tim` (`ketua_tim`),
  CONSTRAINT `FK_tim_pegawai` FOREIGN KEY (`ketua_tim`) REFERENCES `pegawai` (`id_pegawai`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tim_kegiatan` (`id_timkeg`, `id_tim`, `id_pegawai`, `id_role`, `terakhir_login`) VALUES
	...
	(51, 18, 61, 2, '2022-08-25 18:44:43');
